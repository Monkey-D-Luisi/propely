          ...
          {commands.map((command) => (
            <li key={command} role="option" aria-selected={false}>
              <button
                ...
                className="flex w-full items-center gap-2 rounded-lg px-2 py-2 text-left text-sm text-slate-700 transition-colors hover:bg-slate-100 focus:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-primary-600 focus:ring-offset-2"
              >
                <svg
