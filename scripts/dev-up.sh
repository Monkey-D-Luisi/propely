...
echo "    Databases:          propely_aiapi, propely_orgsapi, propely_propertiesapi,"
echo "                        propely_publishingapi, propely_contactsapi, propely_appointmentsapi"
...
if [[ "$START_FULL_STACK" == "true" ]]; then
    ...
    echo "  properties-api:       http://localhost:5030"
    echo "  publishing-api:       http://localhost:5040"
    echo "  contacts-api:         http://localhost:5050"
    echo "  appointments-api:     http://localhost:5060"
    ...
    echo "  properties-api:    ./scripts/run-properties-api.sh"
    echo "  publishing-api:    ./scripts/run-publishing-api.sh"
    echo "  contacts-api:      ./scripts/run-contacts-api.sh"
    echo "  appointments-api:  ./scripts/run-appointments-api.sh"
