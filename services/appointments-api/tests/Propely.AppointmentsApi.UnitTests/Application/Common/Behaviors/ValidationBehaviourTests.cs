...
using MediatR;
using Propely.AppointmentsApi.Application.Common.Behaviors;
using ValidationException = Propely.AppointmentsApi.Domain.Common.Exceptions.ValidationException;

namespace Propely.AppointmentsApi.UnitTests.Application.Common.Behaviors;
