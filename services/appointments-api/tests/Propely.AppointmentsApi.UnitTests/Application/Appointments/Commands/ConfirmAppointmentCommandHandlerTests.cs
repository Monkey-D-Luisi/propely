...
public class ConfirmAppointmentCommandHandlerTests
{
    ...
    [Fact]
    public async Task Handle_ScheduledAppointment_ConfirmsAndReturnsDto()
    {
        ...
        var command = new ConfirmAppointmentCommand(appointment.Id, TenantId);
    ...
    public async Task Handle_NonExistentAppointment_ThrowsNotFoundException()
    {
        ...
        var command = new ConfirmAppointmentCommand(appointmentId, TenantId);
