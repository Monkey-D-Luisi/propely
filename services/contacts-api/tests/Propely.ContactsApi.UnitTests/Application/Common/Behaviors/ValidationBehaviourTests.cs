...
using MediatR;
using Propely.ContactsApi.Application.Common.Behaviors;
using ValidationException = Propely.ContactsApi.Domain.Common.Exceptions.ValidationException;

namespace Propely.ContactsApi.UnitTests.Application.Common.Behaviors;
