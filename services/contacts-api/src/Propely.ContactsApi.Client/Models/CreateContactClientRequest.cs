...
/// <summary>
/// Request to create a new contact via the SDK client.
/// </summary>
public sealed record CreateContactClientRequest
{
    ...
    /// <summary>The contact's roles (e.g., Buyer, Seller, Tenant, Landlord, Professional).</summary>
    ...
    /// <summary>The source of the contact (e.g., Portal, WalkIn, Referral, Website, Phone, Other).</summary>
