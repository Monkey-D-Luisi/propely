# Walkthrough: cr-0018-https-hsts-review

## Task Reference
- Task: `docs/tasks/cr-0018-https-hsts-review.md`
- Walkthrough: `docs/walkthroughs/cr-0018-https-hsts-review.md`
- Branch/PR: `N/A`
- Date: `N/A`

## Summary
Recorded the review for [#31 - feat(security): enforce HTTPS redirection and HSTS](https://github.com/Monkey-D-Luisi/ai-api-template/pull/31) and linked this walkthrough to the review task metadata for traceability.
...
## Context
- Background: Code review captured in `docs/tasks/cr-0018-https-hsts-review.md`.
...
## Files Changed
- `docs/walkthroughs/cr-0018-https-hsts-review.md` — updated walkthrough for this review task.
...
## Docs Updated
- Files updated: `docs/walkthroughs/cr-0018-https-hsts-review.md`.
...
## Checklist
- [x] Task scope matches `docs/tasks/cr-0018-https-hsts-review.md`
