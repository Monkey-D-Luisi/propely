...
using SaasTemplate.AiApi.Infrastructure.Caching;
...
namespace SaasTemplate.AiApi.IntegrationTests.Fixtures;
...
public sealed class ApiWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            services.AddSingleton<IMessagePublisher, SaasTemplate.AiApi.IntegrationTests.Infrastructure.InMemoryMessagePublisher>();
