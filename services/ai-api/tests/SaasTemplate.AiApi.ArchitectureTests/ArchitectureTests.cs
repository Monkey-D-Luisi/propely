...
namespace SaasTemplate.AiApi.ArchitectureTests;

public class ArchitectureTests
{
    private static readonly Assembly DomainAssembly = typeof(WorkItem).Assembly;
    private static readonly Assembly ApplicationAssembly = typeof(SaasTemplate.AiApi.Application.DependencyInjection).Assembly;
    private static readonly Assembly InfrastructureAssembly = typeof(SaasTemplate.AiApi.Infrastructure.DependencyInjection).Assembly;
    private static readonly Assembly ApiAssembly = typeof(SaasTemplate.AiApi.Api.DependencyInjection).Assembly;
