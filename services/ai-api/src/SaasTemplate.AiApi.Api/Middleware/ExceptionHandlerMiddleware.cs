...
using SaasTemplate.AiApi.Api.Services;
...
public sealed class ExceptionHandlerMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        // Cannot write ProblemDetails if the response has already started streaming
        ...
        // Strip internal detail from 500 responses in production
        ...
        {
            // Client disconnected before we could write the response — nothing to do
        }
    }
    ...
    private static (int StatusCode, string Title) MapException(Exception exception) => exception switch
    {
        ...
        AiServiceException => (StatusCodes.Status502BadGateway, "Bad Gateway"),
    ...
    {
        // Suppress exception logging for health check endpoints to reduce noise
        // from orchestrator probes (Docker, Kubernetes) in production logs.
...
/// <summary>
/// Extension methods for ExceptionHandlerMiddleware registration.
/// </summary>
