...
namespace Propely.OrgsApi.Infrastructure.Migrations
{
    ...
    [Migration("20260222151827_AddPermissionOverrides")]
    partial class AddPermissionOverrides
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Propely.OrgsApi.Domain.Agencies.Agency", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Propely.OrgsApi.Domain.Billing.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Propely.OrgsApi.Domain.Billing.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Propely.OrgsApi.Domain.Permissions.PermissionOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId", "OrganizationId", "Permission")
                        .IsUnique()
                        .HasDatabaseName("ix_permission_overrides_user_org_permission");

                    b.ToTable("permission_overrides", (string)null);
                });

            modelBuilder.Entity("Propely.OrgsApi.Domain.Users.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Propely.OrgsApi.Infrastructure.Persistence.Entities.ProcessedWebhookEvent", b =>
                {
            ...
            modelBuilder.Entity("Propely.OrgsApi.Domain.Organizations.Organization", b =>
                {
                    b.HasOne("Propely.OrgsApi.Domain.Agencies.Agency", null)
                        .WithMany()
