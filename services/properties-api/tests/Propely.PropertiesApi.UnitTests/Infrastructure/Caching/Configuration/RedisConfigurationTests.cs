...
namespace Propely.PropertiesApi.UnitTests.Infrastructure.Caching.Configuration;
...
public sealed class RedisConfigurationTests
{
    ...
    public void Defaults_ShouldBeSetCorrectly()
    {
        ...
        config.KeyPrefix.Should().Be("propertiesapi:");
    }
    ...
    public void ShouldImplementICacheSettings()
    {
        ...
        config.Should().BeAssignableTo<Propely.PropertiesApi.Application.Common.Interfaces.ICacheSettings>();
        ((Propely.PropertiesApi.Application.Common.Interfaces.ICacheSettings)config).DefaultTtlMinutes.Should().Be(5);
    }
}
